...
```
### A Note : 
***Termux discourages hacking*** .. So never discuss anything related to *silent_angler* in any of the termux discussion groups. For more check : [wiki](https://wiki.termux.com/wiki/Hacking)
